...
<body>
    ...
    <div class="iframes-container">
        <iframe id="iframe1" style="width: 1344px; height: 800px" src="<?php echo $pages[0]; ?>" allow="autoplay"></iframe>
        <iframe id="iframe2" style="width: 360px; height: 800px" src="<?php echo $pages[0]; ?>" allow="autoplay"></iframe>
    </div>
